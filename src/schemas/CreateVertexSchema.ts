...
export const createVertexSchema = createNotebookCommonSchema.extend({
  ...
  customerEncryptionType: z.enum([PREDEFINED_CMEK, MANUAL_CMEK]).optional(),
  ...
  scheduleFieldCronFormat: z.string().optional(),
  scheduleValueUserFriendly: z.string().optional(),
